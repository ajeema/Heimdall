...
<div class="flex flex-wrap">
    <div class="w-full lg:w-4/12 bg-gray-800 py-6 px-6 rounded-3xl">
...
<br>
<div class="w-full lg:w-12/12 bg-gray-800 py-6 px-6 rounded-3xl">
    <div class="flex justify-between text-white items-center mb-8">
        <p class="text-2xl font-bold">Terminal</p>
    </div>
    <div class="flex flex-wrap">
        <div class="w-full md:w-12/12">
            <div>
